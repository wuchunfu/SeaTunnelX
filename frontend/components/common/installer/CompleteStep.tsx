...
export function CompleteStep({
  ...
  const successfulSteps =
    status?.steps.filter((s) => s.status === 'success').length || 0;
  ...
  return (
    <div className='space-y-6'>
      ...
      <Card
        ...
        data-testid='install-complete-result'
      >
        <CardContent className='pt-8 pb-6'>
          <div className='text-center'>
            ...
            >
              {isSuccess
                ? t('installer.installationSuccess')
                : t('installer.installationFailed')}
            </h2>
            ...
            <p className='text-muted-foreground'>
              {isSuccess
                ...
                : status?.error ||
                  t('installer.installationFailedDesc') ||
      ...
      <Card>
        <CardHeader className='pb-3'>
          <CardTitle className='text-base'>
            {t('installer.installationSummary') || 'Installation Summary'}
          </CardTitle>
        </CardHeader>
        <CardContent className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            <span className='text-sm text-muted-foreground'>
              {t('installer.stepsCompleted') || 'Steps Completed'}
            </span>
      ...
      <Card>
        <CardHeader className='pb-3'>
          <CardTitle className='text-base'>
            {t('installer.nextSteps') || 'Next Steps'}
          </CardTitle>
          <CardDescription>
