...
const markdownComponents: Components = {
  ...
  p: ({children, node}) => {
    ...
    if (hasImage) {
      return (
        <div
          className='mb-4 last:mb-0 leading-7 text-gray-700 dark:text-gray-200 break-all'
          style={{
            wordWrap: 'break-word',
  ...
  li: ({children}) => (
    <li
      className='text-gray-700 dark:text-gray-200 leading-6 break-all'
      style={{
        wordWrap: 'break-word',
        overflowWrap: 'anywhere',
        wordBreak: 'break-all',
  ...
  blockquote: ({children}) => (
    <blockquote
      className='border-l-4 border-blue-500 dark:border-blue-400 pl-6 pr-4 py-4 my-6 bg-gradient-to-r from-blue-50 to-transparent dark:from-blue-900/20 dark:to-transparent italic text-gray-700 dark:text-gray-300 rounded-r-lg relative break-all'
      style={{
        wordWrap: 'break-word',
        overflowWrap: 'anywhere',
        wordBreak: 'break-all',
      ...
      <>
        ...
        <img
          ...
          onError={(e) => {
            ...
            errorDiv.className =
              'bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center text-gray-500 dark:text-gray-400 my-6';
            errorDiv.innerHTML = `
  ...
  th: ({children}) => (
    <th
      className='px-6 py-4 text-left font-semibold text-gray-900 dark:text-gray-100 text-sm tracking-wider break-all'
      style={{
        wordWrap: 'break-word',
        overflowWrap: 'anywhere',
        wordBreak: 'break-all',
  ...
  td: ({children}) => (
    <td
      className='px-6 py-4 text-gray-700 dark:text-gray-300 text-sm break-all'
      style={{
        wordWrap: 'break-word',
        overflowWrap: 'anywhere',
        wordBreak: 'break-all',
